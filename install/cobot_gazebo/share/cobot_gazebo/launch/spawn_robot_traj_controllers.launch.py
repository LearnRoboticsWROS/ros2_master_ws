...
def generate_launch_description():
    ...
    robot_description_file = os.path.join(
        get_package_share_directory('cobot_description'), 'urdf', 'cobot_traj_controller.urdf.xacro'
    )
    joint_controllers_file = os.path.join(
        get_package_share_directory('cobot_gazebo'), 'config', 'controllers_trajectory.yaml'
    )
